<div class="container shadow-lg mt-3 rounded" >
    <div class="shadow-sm ">
        <!-- <div class="row">
            <div class="col-md-12">
...
<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img src="images/sliders/jeju.jpeg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
...
<div id="carouselExampleCaption" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="images/sliders/jeju.jpeg" class="d-block w-100" alt="lion">
                <div class="carousel-caption d-none d-md-block">
                  <h2>Hello World</h2>
              ...
              <div class="carousel-item">
                <img src="images/dark.jpg" class="d-block w-100" alt="lion">
                <div class="carousel-caption d-none d-md-block">
                  <h2>Can I help you?</h2>
                  <p>Yon can talk to me</p>
                </div>
              </div>
            </div>
            <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide="prev">
